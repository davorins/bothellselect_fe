        ...
        <Modal show={addModal} onHide={handleClose} centered size='xl'>
          ...
          <div className='modal-body'>
                ...
                <table className='table datanew'>
                  <thead className='thead-light'>
                    <tr>
                      ...
                      <th className='no-sort'>Player Category</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Ralph</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Julie</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Ryan</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Susan</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Richard</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ms-2'>
                            <p className='text-dark mb-0'>
                              <Link to={routes.playerDetail}>Veronica</Link>
                            </p>
                          </div>
                        </div>
                      </td>
            ...
            <div className='student-pomote-note d-flex mb-0'>
              ...
              <p> Selected 50 Fees Group, 350 Players</p>
            </div>
          </div>
