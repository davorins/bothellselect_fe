...
const HomePage: React.FC<HomePageProps> = ({ onSplashClose }) => {
  ...
  // FIXED: Throttled time update
  const handleTimeUpdate = useCallback(() => {
    if (!videoRef.current || !videoDuration) return;

    // Throttle to 4 times per second (250ms)
    const now = Date.now();
  ...
  return (
    <div className='hp-root'>
      ...
      >
        ...
        {/* <div className='hp-stage__scrim' /> */}
        <div className='hp-overlay'>
          <HomeTileRenderer pageSlug='home' />
        </div>

        <div className='hp-stage__top-stripe-enhanced'></div>
        <div className='hp-stage__bottom-stripe-enhanced'></div>
