        ...
        <div className='content'>
          ...
          <div className='d-md-flex d-block align-items-center justify-content-between mb-3'>
            <div className='my-auto mb-2'>
              <h3 className='page-title mb-1'>Player Dashboard</h3>
              <nav>
            ...
            <div className='col-xl-12'>
              <div className='card flex-fill'>
                ...
                <div className='card-body'>
                  <Slider
                    {...profile}
                    className='coachs-profile-slider owl-carousel'
                  >
                        ...
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          <div className='overflow-hidden'>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Aaron</Link>
                            </h6>
                            <p>Chemistry</p>
                          </div>
                        </div>
                    ...
                    <div className='card bg-light-100 mb-0'>
                      <div className='card-body'>
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          <div>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Hellana</Link>
                            </h6>
                            <p>English</p>
                          </div>
                        </div>
                    ...
                    <div className='card bg-light-100 mb-0'>
                      <div className='card-body'>
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          >
                            <ImageWithBasePath
                              src='assets/img/coachs/coach-05.jpg'
                              alt='Coach'
                            />
                          </Link>
                          <div>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Morgan</Link>
                            </h6>
                            <p>Physics</p>
                          </div>
                        </div>
                    ...
                    <div className='card bg-light-100 mb-0'>
                      <div className='card-body'>
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          <div>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Daniel Josua</Link>
                            </h6>
                            <p>Spanish</p>
                          </div>
                        </div>
                    ...
                    <div className='card bg-light-100 mb-0'>
                      <div className='card-body'>
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          <div>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Teresa</Link>
                            </h6>
                            <p>Maths</p>
                          </div>
                        </div>
                    ...
                    <div className='card bg-light-100 mb-0'>
                      <div className='card-body'>
                        <div className='d-flex align-items-center mb-3'>
                          ...
                          <div>
                            <h6 className='mb-1 text-truncate'>
                              <Link to={routes.coachDetail}>Jacquelin</Link>
                            </h6>
                            <p>Biology</p>
                          </div>
                        </div>
