...
const AdminDashboard = () => {
  ...
  const [coachDonutChart] = useState<any>({
    chart: {
      height: 218,
      width: 218,
      type: 'donut',
          ...
          <>
                  ...
                  <div className='card-body'>
                    <div className='d-flex align-items-center'>
                      <div className='avatar avatar-xl me-2 bg-secondary-transparent p-1'>
                        <ImageWithBasePath
                          src='assets/img/icons/coach.svg'
                          alt='img'
                        />
                      </div>
                      <div className='overflow-hidden flex-fill'>
                      ...
                      <div className='border-start border-skyblue border-3 shadow-sm p-3 mb-3'>
                        <div className='d-flex align-items-center mb-3 pb-3 border-bottom'>
                          ...
                          <div className='flex-fill'>
                            <h6 className='mb-1'>Parents, Coach Meet</h6>
                ...
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <div className='tab-content'>
                      ...
                      <div className='tab-pane fade' id='coachs'>
                        <div className='row gx-3'>
                          <div className='col-sm-4'>
                            <div className='card bg-light-300 shadow-none border-0'>
                              <div className='card-body p-3 text-center'>
                        ...
                        <div className='text-center'>
                          <ReactApexChart
                            id='coach-chart'
                            className='mb-4'
                            options={coachDonutChart}
                            series={coachDonutChart.series}
                            type='donut'
                            height={210}
                          />
                          <Link to='coach-attendance' className='btn btn-light'>
                            <i className='ti ti-calendar-share me-1' />
                            View All
                          </Link>
                        </div>
                ...
                <div className='row flex-fill'>
                        ...
                        <div className='item h-100'>
                          <div className='d-flex justify-content-between flex-column h-100'>
                            <div>
                              ...
                              <p className='text-light'>Physics Coach</p>
                            </div>
                            <ImageWithBasePath
                        ...
                        <div className='item h-100'>
                          <div className='d-flex justify-content-between flex-column h-100'>
                            <div>
                              ...
                              <p className='text-light'>English Coach</p>
                            </div>
                            <ImageWithBasePath
                  ...
                  <div className='col-sm-6 d-flex flex-column'>
                    <div className='bg-info p-3 br-5 text-center flex-fill mb-4 pb-0 owl-height bg-02'>
                      <Slider
                        {...coach}
                        className='owl-carousel coach-slider h-100'
                      >
                        <div className='item h-100'>
                          <div className='d-flex justify-content-between flex-column h-100'>
                            <div>
                              <h5 className='mb-3 text-white'>Star Players</h5>
                        ...
                        <div className='d-flex align-items-center justify-content-between mb-3'>
                          <div className='d-flex align-items-center overflow-hidden me-2'>
                            ...
                            <div className='overflow-hidden'>
                              ...
                              <p className='text-truncate'>Physics Coach</p>
                            </div>
                          </div>
                          <div className='d-flex align-items-center'>
                            <Link
            ...
            <div className='row'>
              ...
              <div className='col-xxl-3 col-xl-6 order-2 order-xxl-3 d-flex flex-column'>
                ...
                <div className='card flex-fill mb-2'>
                  <div className='card-body'>
                    <p className='mb-2'>Player Not Paid</p>
                    <div className='d-flex align-items-end justify-content-between'>
                      <h4>$545</h4>
            ...
            <div className='row'>
              ...
              <div className='col-xxl-4 col-xl-6 d-flex'>
                <div className='card flex-fill'>
                  <div className='card-header  d-flex align-items-center justify-content-between'>
                    <h4 className='card-title'>Player Activity</h4>
                    <div className='dropdown'>
                      <Link
                        to='#'
                        className='bg-white dropdown-toggle'
