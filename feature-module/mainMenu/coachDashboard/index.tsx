        ...
        <div className='content'>
          ...
          <div className='d-md-flex d-block align-items-center justify-content-between mb-3'>
            <div className='my-auto mb-2'>
              <h3 className='page-title mb-1'>Coach Dashboard</h3>
              <nav>
            ...
            <div className='col-xxl-8 col-xl-12'>
              ...
              <div className='row'>
                ...
                <div className='col-xxl-6 col-xl-6 col-md-6 d-flex flex-column'>
                  ...
                  <div className='card flex-fill'>
                    <div className='card-header d-flex align-items-center justify-content-between'>
                      <h4 className='card-title'>Player Progress</h4>
            ...
            <div className='col-xxl-8 col-xl-7 d-flex'>
              <div className='card flex-fill'>
                <div className='card-header d-flex align-items-center justify-content-between flex-wrap'>
                  <h4 className='card-title '>Player Marks</h4>
                  <div className='d-flex align-items-center'>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className='d-flex align-items-center'>
                              ...
                              <div className='ms-2'>
                                <p className='text-dark mb-0'>
                                  <Link to={routes.playerDetail}>Kathleen</Link>
                                </p>
                              </div>
                            </div>
                          </td>
